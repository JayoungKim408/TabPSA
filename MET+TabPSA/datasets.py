...
class TabularDataset():
    def __init__(self, dataset, cont_method='raw', categ_method='label', y_method='label'):
        """
        Arguments
        ...
        self.indexes = self.categ_index[:], self.cont_index[:]
        ...
        self.val_y = self.val_y.astype(np.int64)
        self.test_y = self.test_y.astype(np.int64)
    ...
    def preprocessing(self):
        ...
        # TODO: consider the case where y is one-hot encoded
